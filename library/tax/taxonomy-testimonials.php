...
/*-----------------------------------------------------------------------------------*/
/*	Custom Taxonomy for Testimonials
/*-----------------------------------------------------------------------------------*/
function am_testimonials_taxonomy() {

	$labels = array(
		'name'                       => _x( 'Testimonial Categories', 'Taxonomy General Name', 'am_sandbox_theme' ),
		'singular_name'              => _x( 'Testimonial Category', 'Taxonomy Singular Name', 'am_sandbox_theme' ),
		'menu_name'                  => __( 'Testimonial Category', 'am_sandbox_theme' ),
...
add_action( 'init', 'am_testimonials_taxonomy', 0 );