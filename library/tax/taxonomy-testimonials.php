...
function am_testimonials_taxonomy() {
	...
	$labels = array(
		'name'                       => _x( 'Testimonial Categories', 'Taxonomy General Name', 'am_boiler' ),
		'singular_name'              => _x( 'Testimonial Category', 'Taxonomy Singular Name', 'am_boiler' ),
		'menu_name'                  => __( 'Testimonial Category', 'am_boiler' ),
