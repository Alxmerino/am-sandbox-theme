...
function am_clients_taxonomy() {
	...
	$labels = array(
		'name'                       => _x( 'Client Categories', 'Taxonomy General Name', 'am_boiler' ),
		'singular_name'              => _x( 'Client Category', 'Taxonomy Singular Name', 'am_boiler' ),
		'menu_name'                  => __( 'Client Category', 'am_boiler' ),
